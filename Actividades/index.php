...
<head>
    ...
    <title>SISTI | Conferencias y Concursos</title>
    <!-- Favicon-->
...
<body class="theme-sisti ls-closed">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card" id="Conferencias">
                        <div class="body">
                            <div class="row">
    ...
    <div class="fixed-action-btn" data-toggle="tooltip" data-placement="left" title="Nueva Actividad">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="formModal">Registro de Actividad</h5>
                </div>
                        ...
                        <fieldset class="card">
                            <div class="body">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="form-label">Tipo de actividad</label>
                                        <select class="form-control show-tick" id="tipo" name="tipo">
                                            <option value="Conferenci">Conferencia</option>
