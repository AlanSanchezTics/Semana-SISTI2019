<?php
    ...
    tbl_pagos.monto,tbl_alumnos.imagen,tbl_alumnos.alugenero,tbl_alumnos.nocontrol 
        FROM tbl_alumnos,tbl_usuarios,tbl_carreras,tbl_grupo,tbl_pagos,tbl_asig_grupo_alumn where tbl_usuarios.idusuario=? and tbl_alumnos.nocontrol=tbl_usuarios.usuario AND
        tbl_alumnos.idcarrera=tbl_carreras.idcarrera and tbl_asig_grupo_alumn.nocontrol = tbl_alumnos.nocontrol and tbl_asig_grupo_alumn.idgrupo= tbl_grupo.idgrupo and 
    ...
    $al_amaterno,$al_turno,$al_semestre,$al_grupo,$al_monto,$al_imagen,$al_genero,$id_alu);
