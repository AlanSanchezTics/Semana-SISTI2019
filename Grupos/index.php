...
<body class="theme-sisti ls-closed">
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a class="editar waves-effect waves-block">Editar grupo <i class="material-icons">edit</i></a></li>
                                        <li><a class="eliminar waves-effect waves-block">Eliminar grupo <i class="material-icons">delete</i></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="fixed-action-btn" data-toggle="tooltip" data-placement="left" title="Nuevo Grupo">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="formModal">Registro de Grupo</h5>
                </div>
                        ...
                        <fieldset class="card">
                            ...
                            <div class="body">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="form-label">Semestre</label>
                                        <select class="form-control show-tick" id="Semestre" name="semestre">
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
